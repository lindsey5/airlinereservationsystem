...
import {frontDeskRequireAuth} from '../middleware/frontDeskRequireAuth.js';

const router = express.Router();

router.post('/', adminRequireAuth, create_flight);
router.put('/cancel/passenger', cancelPassengerFlight);
...
router.post('/book/frontdesk', frontDeskRequireAuth ,frontdesk_book_flight);
